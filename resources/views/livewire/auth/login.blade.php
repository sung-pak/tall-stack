...
<div class="flex flex-col justify-center min-h-screen py-12 bg-gray-50 sm:px-6 lg:px-8 dark:bg-zinc-800 dark:text-indigo-600">
  ...
  <div>
      <div class="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h2 class="mt-6 text-3xl font-extrabold text-center text-gray-900 dark:text-zinc-600 leading-9">
      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div class="px-4 py-8 bg-white dark:bg-zinc-400 shadow sm:rounded-lg sm:px-10">
